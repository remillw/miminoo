...
import { BarChart2, Briefcase, Calendar, CreditCard, Home, LogOut, MessageCircle, Settings, User, Menu, X } from 'lucide-vue-next';
...
<template>
    ...
    <aside class="hidden lg:flex min-h-screen w-64 flex-col border-r bg-white">

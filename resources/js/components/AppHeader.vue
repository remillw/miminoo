...
const activeItemStyles = computed(() => (url: string) => (isCurrentRoute.value(url) ? 'text-neutral-900 bg-neutral-100' : ''));
    ...
    <div>
        <div class="border-sidebar-border/80 border-b">
            <div class="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                ...
                <Link href="/tableau-de-bord" class="flex items-center gap-x-2">
                    <AppLogo />
                </Link>

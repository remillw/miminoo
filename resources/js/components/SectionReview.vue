<template>
    <section class="bg-secondary w-full py-8 sm:py-12 md:py-16">
        <div class="mx-auto max-w-5xl px-4">
            <!-- Titre -->
            <h2 class="mb-2 text-center text-xl font-bold sm:text-2xl md:text-3xl">Ce que les parents disent de nous</h2>
            ...
            <ReviewCard v-bind="reviews[current]">
                <template #navigation>
                    <div class="absolute bottom-3 left-1/2 flex -translate-x-1/2 items-center gap-2 sm:bottom-5 sm:gap-4">
                        <!-- Flèche gauche -->
                        <button @click="prev" class="rounded-full border border-gray-200 bg-white p-1.5 shadow-sm transition hover:bg-gray-50 sm:p-2">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                class="h-3 w-3 text-gray-900 sm:h-4 sm:w-4"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                            >
                        ...
                        <!-- Flèche droite -->
                        <button @click="next" class="rounded-full border border-gray-200 bg-white p-1.5 shadow-sm transition hover:bg-gray-50 sm:p-2">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                class="h-3 w-3 text-gray-900 sm:h-4 sm:w-4"
                                fill="none"

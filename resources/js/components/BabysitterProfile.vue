<template>
    <div class="mx-auto max-w-4xl space-y-6">
        ...
        <!-- Section Avis -->
        <div v-if="props.reviews && props.reviews.length > 0" class="rounded-lg border bg-white p-6 shadow-sm">
            <div class="mb-4 flex items-center gap-2">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-sm text-gray-500">({{ props.totalReviews || 0 }} avis)</span>
                </div>
            </div>

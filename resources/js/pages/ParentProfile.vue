    ...
    <GlobalLayout>
                        ...
                        <div class="space-y-4">
                            ...
                            >
                                <div class="mb-3 flex items-start justify-between">
                                    ...
                                    <div>
                                        <span :class="getAnnouncementStatusColor(ad.status).badge" class="rounded-full px-2 py-1 text-xs font-medium">
                    ...
                    <div class="rounded-2xl bg-white p-6 shadow-sm">
                        ...
                        <div v-if="reviews && reviews.length > 0">
                            ...
                            <button
                                ...
                                class="mt-4 w-full rounded-lg border border-blue-200 px-4 py-2 text-center font-medium text-blue-600 transition-colors hover:bg-blue-50 hover:text-blue-800"
                            >
        ...
        <div v-if="showAllReviews" class="fixed inset-0 z-50 overflow-y-auto">
            <div class="flex min-h-screen items-center justify-center p-4">
                <div class="bg-opacity-50 fixed inset-0 bg-black" @click="showAllReviews = false"></div>
                <div class="relative max-h-[80vh] w-full max-w-2xl overflow-hidden rounded-lg bg-white shadow-xl">
                    <div class="flex items-center justify-between border-b p-6">
                        <h3 class="text-lg font-semibold text-gray-900">Tous les avis ({{ totalReviews }})</h3>
                    ...
                    <div class="max-h-[60vh] overflow-y-auto p-6">
                        <div class="space-y-6">
                            <div v-for="review in reviews" :key="review.id" class="border-b border-gray-200 pb-4 last:border-b-0 last:pb-0">
